Public Sub populateCheckBoxUpdated()
'-----------------------------------------------------------------------------------------------
' [VBA]
'   Name........: populateCheckBoxUpdated:
'   Description.: atualiza os checkBoxs para consulta de contratos já preenchidos
'   ------------:
...
Dim objLineUpdate As Integer: objLineUpdate = handleHack(FRONT.Range("B2").Value) 'Celula com INDEX para update de informação
